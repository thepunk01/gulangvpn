...
import { V2BoardService, type V2BoardUserInfo as V2BoardUserInfoData } from '@/services/v2board'
import { showNotice } from '@/services/notice-service'

export const V2BoardUserInfo = () => {
  const navigate = useNavigate()
  const [userInfo, setUserInfo] = useState<V2BoardUserInfoData | null>(null)
